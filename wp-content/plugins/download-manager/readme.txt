...
* [Microsoft Office Doc Preview](https://www.microsoft.com/en/microsoft-365/free-office-online-for-the-web)

Our plugin provides the ability to preview Microsoft Office documents for user convenience. This feature may rely on Microsoft services. Users may be subject to Microsoft's privacy policies and terms when accessing and previewing Office documents through this plugin. Please consult [Microsoft's Privacy Statement](https://privacy.microsoft.com/en-us/privacystatement) and [Terms of Use](https://www.microsoft.com/en-us/servicesagreement) for further information.

* [Google Doc Preview](https://docs.google.com/)

This plugin may offer Google Doc preview functionality for certain file types. Users may interact with Google's services during the preview process. Google's Privacy Policy and Terms of Service apply when using this feature. You can find these policies at [https://policies.google.com/privacy](https://policies.google.com/privacy) and [https://policies.google.com/terms](https://policies.google.com/terms).
...
* Updated vue js
* Fixed an issue with the premium package add-on activation ( Reported by Ananda Dhakal from Patchstack )
* Fixed an issue with the lock option iframe ( Reported by Ananda Dhakal from Patchstack )

= 3.3.24 - 2025.09.16 =
* Fixed an issue with the download stats page ( reported by Wordfence )

= 3.3.23 - 2025.09.04 =
* Improved download stats page

= 3.3.22 - 2025.09.01 =
* Fixed an sanitization issue with the all downloads short-code
* Improved cron-job routine

= 3.3.21 - 2025.08.21 =
* Improved front-end user dashboard

= 3.3.20 - 2025.08.06 =
* Fixed an IPv6 compatibility issue with the wpdm stats data

= 3.3.19 - 2025.06.18 =
* Fixed an sanitization issue with the image alt attribute in wpdm_thumb function ( Reported by Wordfence )

= 3.3.18 - 2025.06.10 =
* Improved MimeType validation function
* Fixed a post content sanitization issue

= 3.3.17 - 2025.05.07 =
* Fixed a compatibility issue with Dropbox integration

= 3.3.16 - 2025.05.07 =
* Fixed an issue with the `getMimeType` function

= 3.3.15 - 2025.05.01 =
* Fixed an issue with the URL validation function
* Fixed an issue with the modal login form

= 3.3.14 - 2025.04.21 =
* Improved mime type detection function
* Compatibility update for WorPress 6.8
...
= 3.3.12 - 2025.04.07 =
* Improved codebase
* Resolved an issue with attaching files from cloud storage

= 3.3.11 - 2025.03.24 =
* Improved URL validation function

= 3.3.10 - 2025.03.23 =
* Fixed an issue with functions handling password-protected media files

= 3.3.09 - 2025.03.10 =
* Improved front-end ui
* Fixed an issue with the Asset Manager ( Reported by Wordfence )

= 3.3.08 - 2025.02.05 =
* Fixed an issue with translation
* Improved sanitization function


= 3.3.07 - 2025.01.24 =
* Improved front-end UI
* Fixed an issue with directory browsing

= 3.3.06 - 2025.01.15 =
* Removed FontAwesome from front-end
* Fixed an issue with the login form

= 3.3.05 - 2025.01.08 =
* Removed bootstrap to minimize javascript and css overload
* Improved UI options

= 3.3.04 - 2024.12.05 =
* Fixed an issue with the media access control function  ( reported by Rafie Muhammad from Patchstack )
* Fixed an issue with the shortcode-iframe page ( reported by Emiliano Versini to Wordfence )
...
= 3.2.95 - 2024.06.04 =
* Fixed an issue with the `wpdm_all_packages` shortcode

= 3.2.94 - 2024.06.03 =
* Fixed a parameter sanitization issue with the `wpdm_modal_login_form` shortcode

= 3.2.93 - 2024.06.03 =
* Fixed an input sanitization issue with `wpdm_all_packages` shortcode ( Reported by WordFence  )
* Fixed an issue with the master key validation
