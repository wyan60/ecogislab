 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_checkbox( $input ) {
	if ( "1" == $input ) {
		return "1";
	}
	else {
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_custom_css( $input ) {
	if ( '' != $input ) {
 ...
 */
function catcheverest_sanitize_image( $image, $setting ) {
	/*
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_post_id( $input ) {
 ...
 * @since Catch Everest 1.4
 */
function catcheverest_sanitize_category_list( $input ) {
	if ( '' != $input ) {
		if( in_array( 0, $input ) ) {
			return '0';
		}
 ...
 *                    the setting default.
 */
function catcheverest_sanitize_number_range( $number, $setting ) {
