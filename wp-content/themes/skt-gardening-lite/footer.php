...
<div class="container">
     <div class="copyright-txt">
		...
		<?php } ?>        
        <?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-gardening-lite');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/free-wordpress-themes/');?>" target="_blank"> <?php esc_html_e('SKT Free Themes','skt-gardening-lite'); ?> </a>
        </div>
     <div class="clear"></div>
</div>           
</div>
