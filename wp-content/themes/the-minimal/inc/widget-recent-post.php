                    ...
                    <li>
                            ...
                            <div class="image">
                                <a href="<?php the_permalink();?>" class="post-thumbnail">
                                    ...
                                    if ( has_post_thumbnail() ) {
                                        the_post_thumbnail( 'the-minimal-post-thumb', array( 'itemprop' => 'image' ) );
                                    }else{
                                        the_minimal_get_fallback_svg( 'the-minimal-post-thumb' );
                                    } ?>
                                </a>
                            </div>
                        <?php } ?>
						<div class="text">
							...
							<?php if( $show_postdate ){?>
                                <span class="date"><a href="<?php the_permalink(); ?>"><time datetime="<?php echo esc_attr( get_the_date('Y-m-d' ) ); ?>"><?php echo esc_html( get_the_date('F jS, Y') ); ?></time></a></span>
                            <?php }?>
						</div>                        
                    </li>        
                <?php    
