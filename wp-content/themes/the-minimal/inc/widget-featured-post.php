...
class The_Minimal_Featured_Post extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$excerpt_char   = ! empty( $instance['excerpt_char'] ) ? $instance['excerpt_char'] : 20 ;
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'excerpt_char' ) ); ?>"><?php _e( 'Excerpt Word Count', 'the-minimal' ); ?></label> 
