...
function the_minimal_save_sidebar_layout( $post_id ) { 
    global $the_minimal_sidebar_layout; 
    ...
    $layout = isset( $_POST['the_minimal_sidebar_layout'] ) ? sanitize_key( $_POST['the_minimal_sidebar_layout'] ) : 'right-sidebar';

    if( array_key_exists( $layout, $the_minimal_sidebar_layout ) ){
        update_post_meta( $post_id, 'the_minimal_sidebar_layout', $layout );
    }else{
        delete_post_meta( $post_id, 'the_minimal_sidebar_layout' );
    }     
}
