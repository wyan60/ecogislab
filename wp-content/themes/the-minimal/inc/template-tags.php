...
function the_minimal_posted_on() {
    ...
    $comment_count = sprintf( _nx( '%1$s Comment', '%1$s Comments', get_comments_number(), 'comments title', 'the-minimal' ), number_format_i18n( get_comments_number() ) ); 
	
    $comment = '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $comment_count . '</a>';
