...
class The_Minimal_Social_Links extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        if( $facebook || $twitter || $linkedin || $googleplus || $pinterest || $instagram || $youtube || $vimeo || $ok || $vk || $xing || $tiktok  ){ 
	...
	public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'ok' ) ); ?>"><?php _e( 'OK', 'the-minimal' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'vk' ) ); ?>"><?php _e( 'VK', 'the-minimal' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'xing' ) ); ?>"><?php _e( 'Xing', 'the-minimal' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'tiktok' ) ); ?>"><?php _e( 'Tiktok', 'the-minimal' ); ?></label> 
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'tiktok' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'tiktok' ) ); ?>" type="text" value="<?php echo esc_url( $xing ); ?>" />
            <small><?php esc_html_e( 'Leave blank if you do not want to show.', 'the-minimal' ); ?></small>
		</p>
        <?php 
	}
