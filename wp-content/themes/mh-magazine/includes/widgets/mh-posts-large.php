...
class mh_magazine_posts_large extends WP_Widget {
	function __construct() {
		parent::__construct(
			'mh_magazine_posts_large', esc_html_x('MH Posts Large', 'widget name', 'mh-magazine'),
			array(
				'classname' => 'mh_magazine_posts_large',
